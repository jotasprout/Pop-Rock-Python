...
# Part of URL for getting MusicBrainz release's artist relationships
#Do I really need multiple of these? Probably not. 
MusicBrainz_releaseArtistRels = '?inc=artist-rels'
