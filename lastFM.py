...
# Example of result from line 137 using TYR
# Only gets one release
# The album MBID used in the URL is the release MBID and is not the one returned as the album's MBID so this is, I am now pretty sure, where the screwup is happening
...
# Example of result from line0184
