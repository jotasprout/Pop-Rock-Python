...
print ("Getting Artist info from MusicBrainz")
...
print ("Printing release-groups so I can check if response includes genres")
pprint.pprint(releaseGroupsJSON)
...
artist['Albums'] = allNewReleaseGroups
